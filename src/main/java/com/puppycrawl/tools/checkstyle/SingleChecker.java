 ...
 */
public class SingleChecker extends AutomaticBean implements MessageDispatcher, RootModule {
    ...
    protected void workFile(File file, long timestamp) throws Exception {
        ...
        final SortedSet<Violation> fileResults = processFile(file);
     ...
     * @param timestamp The timestamp of the file.
     */
    protected void endWorkingFile(String fileName, SortedSet<Violation> messages,
            long timestamp) {
        fireErrors(fileName, messages);
        fireFileFinished(fileName);
        if (cacheFile != null && messages.isEmpty()) {
     ...
     * @throws CheckstyleException if error condition within Checkstyle occurs.
     */
    public static SortedSet<Violation> processFile(File file, String charset,
        ...
        try {
            ...
            fileMessages.add(new Violation(1,
                    ...
                    new String[] {ioe.getMessage()}, null, SingleChecker.class, null));
        }
