...
public class InnerAssignmentCheckTest
    ...
    public void testTokensNotNull() {
        ...
        assertNotNull("Unexpected acceptable tokenks", check.getAcceptableTokens());
        assertNotNull("Unexpected default tokens", check.getDefaultTokens());
        assertNotNull("Unexpected required tokens", check.getRequiredTokens());
    }
