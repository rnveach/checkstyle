...
public class AllChecksTest extends BaseCheckTestSupport {
    ...
    public void testAllUserDefinedFieldsHaveAnnotation() throws Exception {
        for (Class<?> module : CheckUtil.getCheckstyleModules()) {
            ...
            for (Field field : TestUtils.getFields(module)) {
    ...
    public void testAllNonUserDefinedCheckFieldsAreReset() throws Exception {
        ...
        for (Class<?> check : CheckUtil.getCheckstyleChecks()) {
            ...
            final Set<Field> fields = TestUtils.getFields(check);
            ...
            for (Field field : fields) {
                ...
                if (type == boolean.class) {
                    ...
                    field.set(instance, ((Integer) field.get(instance)).intValue() + 1);
                } else {
            ...
            ((AbstractCheck) instance).setMessages(messages);
