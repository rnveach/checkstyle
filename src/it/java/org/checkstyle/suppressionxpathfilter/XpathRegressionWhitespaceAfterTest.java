...
public class XpathRegressionWhitespaceAfterTest extends AbstractXpathTestSupport {
    ...
    public void testWhitespaceAfterTypecast() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathRegressionWhitespaceAfterTypecast.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/CLASS_DEF[./IDENT["
                + "@text='InputXpathRegressionWhitespaceAfterTypecast']]/OBJBLOCK"
    ...
    public void testWhitespaceAfterNotFollowed() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathRegressionWhitespaceAfterNotFollowed.java"));
        ...
        final List<String> expectedXpathQueries = Collections.singletonList(
            "/CLASS_DEF[./IDENT["
                + "@text='InputXpathRegressionWhitespaceAfterNotFollowed']]/OBJBLOCK"
