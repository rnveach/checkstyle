...
public class XpathRegressionMultipleVariableDeclarationsTest extends AbstractXpathTestSupport {
    ...
    public void testOne() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathRegressionMultipleVariableDeclarationOne.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
            "/CLASS_DEF[./IDENT["
                + "@text='InputXpathRegressionMultipleVariableDeclarationOne']]/OBJBLOCK"
    ...
    public void testTwo() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathRegressionMultipleVariableDeclarationTwo.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
            "/CLASS_DEF[./IDENT["
                + "@text='InputXpathRegressionMultipleVariableDeclarationTwo']]/OBJBLOCK"
