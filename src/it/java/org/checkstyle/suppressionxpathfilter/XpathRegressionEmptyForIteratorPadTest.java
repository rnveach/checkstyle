...
public class XpathRegressionEmptyForIteratorPadTest extends AbstractXpathTestSupport {
    ...
    public void testFollowed() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathRegressionEmptyForIteratorPadFollowed.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
            "/CLASS_DEF[./IDENT["
                + "@text='InputXpathRegressionEmptyForIteratorPadFollowed']]/OBJBLOCK"
    ...
    public void testNotFollowed() throws Exception {
        final File fileToProcess =
                new File(getPath("InputXpathRegressionEmptyForIteratorPadNotFollowed.java"));
        ...
        final List<String> expectedXpathQueries = Arrays.asList(
            "/CLASS_DEF[./IDENT["
                + "@text='InputXpathRegressionEmptyForIteratorPadNotFollowed']]/OBJBLOCK"
                + "/METHOD_DEF[./IDENT[@text='method']]/SLIST/LITERAL_FOR/FOR_ITERATOR",
            "/CLASS_DEF[./IDENT["
                + "@text='InputXpathRegressionEmptyForIteratorPadNotFollowed']]/OBJBLOCK"
                + "/METHOD_DEF[./IDENT[@text='method']]/SLIST/LITERAL_FOR/RPAREN"
